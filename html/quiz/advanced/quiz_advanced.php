...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <link rel="stylesheet" href="../../css/quiz_a.css"/>
      ...
      <div class="container-center bg-body-tertiary bordered-container">
        <div class="btn-top-right">
          <div class="btn-group">
            ...
            <a href="../advanced.php" class="btn btn-outline-dark">Ακύρωση</a>
          </div>
        </div>
        <div class="d-flex flex-nowrap">
          <div class="d-flex flex-column align-items-stretch flex-shrink-0 bg-body-tertiary" style="width: 280px;">
            <a href="/" class="d-flex align-items-center flex-shrink-0 p-3 link-body-emphasis text-decoration-none border-bottom">
              ...
              <span class="fs-5 fw-semibold" id="quiz-title">Προχωρημένο επίπεδο</span>
            </a>
